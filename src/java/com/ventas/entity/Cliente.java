...
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findByNombreRazons", query = "SELECT c FROM Cliente c WHERE c.nombreRazons = :nombreRazons"),
...
public class Cliente implements Serializable {
    ...
    public String toString() {
        return "com.ventas.entity.Cliente[ idCliente=" + idCliente + " ]";
    }
